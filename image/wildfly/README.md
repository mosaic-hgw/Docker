...
> docker run --rm mosaicgreifswald/wildfly versions
  last updated               : 2024-06-10 12:42:49
...
| Date                               | Tags                                                                                                                                                               | Changes                                                                                                                                                            |
|------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2024-06-10                         | `32-20240610`, `32`, `latest`  ([Dockerfile](https://github.com/mosaic-hgw/Docker/blob/main/image/wildfly/Dockerfile.wildfly.32))                                  | **MySQL-Connector** 8.4.0                                                                                                                                          |
