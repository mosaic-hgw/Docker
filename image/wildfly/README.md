...
| /entrypoint-wildfly-server-keystore | ENTRY_WILDFLY_SERVER_KEYSTORE | file   | to export all available log-files (read-only access)                                                                               |
...
> docker run --rm mosaicgreifswald/wildfly versions
  last updated               : 2024-09-09 09:16:04
...
| Date                               | Tags                                                                                                                                                                         | Changes                                                                                                                                                            |
|------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2024-09-09<br><br>                 | `32-20240909`, `32`, `latest` ([Dockerfile](https://github.com/mosaic-hgw/Docker/blob/77443c702b70f94709874960b54328a478d6c880/image/wildfly/Dockerfile.wildfly.32))<br><br> | **Debian** 12.7 "bookworm"<br>experimental keystore for server-certificate                                                                                         |
