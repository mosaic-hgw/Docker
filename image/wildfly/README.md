...
| Logging    | WF_SYSTEM_LOG_LEVEL         | SEVERE\|FATAL\|ERROR\|WARN\|INFO\|DEBUG\|TRACE\|FINE **improved** | INFO              | this can be used to set the log level of the console                                                                   |
| Logging    | WF_SYSTEM_LOG_COLORS        | \<LEVEL\>:\<COLOR\>\[,\<LEVEL\>:\<COLOR\>\[,...]] **new**         | -                 | this map allows a comma delimited list of colors to be used for different levels with a pattern formatter              |
...
> docker build --tag="mosaicgreifswald/wildfly" --file="Dockerfile.wildfly.38" .

# "versions" shows all installed tools and components, with their versions.
> docker run --rm mosaicgreifswald/wildfly versions
  last updated               : 2026-05-20 08:46:06
  Architecture               : x86_64
...
| Date                                   | Tags                                                                                                                                                                                                                                                                                                                                                                                                  | Changes                                                                                                                                                                                               |
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2026-05-20<br><br><br><br><br>         | [38-20260520](https://hub.docker.com/r/mosaicgreifswald/wildfly/tags?name=38-20260520), [38](https://hub.docker.com/r/mosaicgreifswald/wildfly/tags?name=38), [latest](https://hub.docker.com/r/mosaicgreifswald/wildfly/tags?name=latest) ([Dockerfile](https://github.com/mosaic-hgw/Docker/blob/27824125287209dd59253f5a5f155cc9dead7787/image/wildfly/Dockerfile.wildfly.38))<br><br><br><br><br> | **Debian** 13.5 "trixie"<br>**openJRE** 21.0.11<br>**MySQL-Connector** 9.7.0<br>**MariaDB-Connector** 3.5.8<br>**PostgreSQL-Connector** 42.7.11                                                       |
