...
> docker run --rm mosaicgreifswald/wildfly versions
  last updated               : 2024-06-03 10:54:32
...
| Date                               | Tags                                                                                                                                                                         | Changes                                                                                                                                                            |
|------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2024-06-03                         | `32-20240603`, `32`, `preview`  ([Dockerfile](https://github.com/mosaic-hgw/Docker/blob/main/image/wildfly/Dockerfile.wildfly.32))                                           | **WildFly** 32.0.1.Final                                                                                                                                           |
