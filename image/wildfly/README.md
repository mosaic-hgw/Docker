...
| Processing | WF_WAIT_FOR_PORTS           | \<HOST\>:\<PORT\>\[:\<TIMEOUT\>],...             | -                 | just like MOS_WAIT_FOR_PORTS, but waits until after JBoss-CLI                                                    |
...
| Date                                   | Tags                                                                                                                                                                                                                                                                                                                                                                                              | Changes                                                                                                                                                                                               |
|----------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2026-01-26<br><br><br><br>             | [38-20260126](https://hub.docker.com/r/mosaicgreifswald/wildfly/tags?name=38-20260126), [38](https://hub.docker.com/r/mosaicgreifswald/wildfly/tags?name=38), [latest](https://hub.docker.com/r/mosaicgreifswald/wildfly/tags?name=latest) ([Dockerfile](https://github.com/mosaic-hgw/Docker/blob/edf0ca327bc7a7c9c6c10f78b37eb2ffd0e8aad3/image/wildfly/Dockerfile.wildfly.38))<br><br><br><br> | **Debian** 13.3 "trixie"<br>**openJRE** 21.0.10<br>**MariaDB-Connector** 3.5.7<br>**PostgreSQL-Connector** 42.7.9<br>**EclipseLink** 4.0.9                                                            |
