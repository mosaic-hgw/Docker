...
| Date       | Tags                                                                                                                                                     | Changes                                              |
|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------|
| 2024-03-05 | `5.6.3`, `5`, `latest` ([Dockerfile](### Der jMeter-Layer
#### 1 Allgemeines
This layer is only used to automatically execute tests without a GUI.
The layer can be created to generate a separate jMeter image, which is integrated via Docker-Compose,
or a complete test image, which is based on a `wildfly-db` image.
...
| Date                               | Tags                                                                                                                                                                               | Changes                                                                                                                                                           |
|------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2024-03-05<br><br><br><br><br><br> | `5.6.3`, `5`, `latest` ([Dockerfile](https://github.com/mosaic-hgw/Docker/blob/091ee8d29e826294ea5c01bc1d0039dd73b3db4e/image/jmeter/Dockerfile.jmeter.5))<br><br><br><br><br><br> | **Debian** 12.5 "bookworm"<br>**zulu-jre** 21.0.2<br>**jMeter** 5.6.3<br>**jMeter-Plugins** 1.4.0<br>**java-json** 20240303<br>**jmeter-prometheus-plugin** 0.7.1 |
